 ...
 */
     ...
     * Description: To Verify Checkbox or Radio button is selected or not
     * Input Parameters: Element Xpath
     * Output: True/False
     * Author: Testing Master
     * Organization: Testing Master Technologies
     ...
     * ######################################################################################################
     */
        public static Boolean VerifyElementSelected(String ObjectXpath, boolean expected)
        {
            Boolean stepStatus = true;
            try
            {
            	Highlight(ObjectXpath);
            	boolean retval = driver.findElement(By.xpath(ObjectXpath)).isSelected();
            	if(retval==expected)
            		stepStatus = true;
            	else
            		stepStatus = false;            	
